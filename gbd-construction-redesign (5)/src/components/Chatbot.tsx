  ...
  const sendMessage = async (text: string) => {
    ...
    try {
      ...
      if (contentType && contentType.includes('text/html')) {
        setMessages(prev => [...prev, { role: 'model', text: 'Error: The chatbot backend is not reachable. Ensure the app is deployed as a full-stack Node.js server, not just a static frontend.' }]);
        setIsLoading(false);
        return;
      }
