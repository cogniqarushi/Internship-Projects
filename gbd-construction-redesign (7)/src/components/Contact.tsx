      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg">425 Mathers Ave Suite 101<br/>Saint-Eustache, QC J7P 4C1</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <a href="https://maps.google.com/?q=425+Mathers+Ave+Suite+101,+Saint-Eustache,+Quebec+J7P+4C1" target="_blank" rel="noopener noreferrer" className="h-[250px] w-full bg-gray-200 relative overflow-hidden group block cursor-pointer">
              <img 
