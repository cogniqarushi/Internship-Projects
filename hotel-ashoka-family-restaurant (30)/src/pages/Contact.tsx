        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <img 
              ...
              alt="Map" 
              className="absolute inset-0 w-full h-full object-cover opacity-30 grayscale mix-blend-multiply group-hover:scale-105 transition-transform duration-700"
            />
            ...
            <a 
              ...
              className="absolute inset-0 text-center p-8 cursor-pointer flex flex-col items-center justify-center group"
            >
              <div className="bg-brand-cream/90 backdrop-blur-md px-8 py-4 rounded-full shadow-xl border border-brand-yellow/30 flex items-center gap-3 group-hover:bg-brand-cream transition-colors duration-300 transform group-hover:-translate-y-2">
                <MapPin className="w-6 h-6 text-brand-dark" />
                <span className="text-brand-dark font-bold text-lg">Hotel Ashoka</span>
              </div>
            </a>
          </motion.div>
        </div>
