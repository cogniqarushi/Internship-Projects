    ...
    <div className="min-h-screen bg-brand-cream relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <img 
          src="https://png.pngtree.com/png-clipart/20220804/ourmid/pngtree-aesthetic-paper-notes-png-image_6098989.png"
          alt=""
          className="absolute -left-20 bottom-10 w-[500px] h-[500px] opacity-15 pointer-events-none object-contain mix-blend-multiply grayscale brightness-[1.05] contrast-[1.1] -scale-x-100 -rotate-45"
          referrerPolicy="no-referrer"
        />
        <img 
          src="https://png.pngtree.com/png-clipart/20220804/ourmid/pngtree-aesthetic-paper-notes-png-image_6098989.png"
          alt=""
          className="absolute -right-20 -bottom-10 w-[600px] h-[600px] opacity-15 pointer-events-none object-contain mix-blend-multiply grayscale brightness-[1.05] contrast-[1.1] -rotate-45"
          referrerPolicy="no-referrer"
        />
      </div>
      {/* Hero Section */}
      ...
      <div className="py-24 bg-brand-cream relative overflow-hidden">
        ...
        <img 
          src="https://png.pngtree.com/png-clipart/20220804/ourmid/pngtree-aesthetic-paper-notes-png-image_6098989.png"
          alt=""
          className="absolute -right-20 bottom-0 w-[500px] h-[500px] opacity-15 pointer-events-none object-contain mix-blend-multiply grayscale brightness-[1.05] contrast-[1.1] rotate-180 z-0"
          referrerPolicy="no-referrer"
        />
