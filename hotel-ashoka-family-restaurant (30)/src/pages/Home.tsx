            ...
            {[
              ...
              >
                ...
                <img 
                  src="https://png.pngtree.com/png-clipart/20220804/ourmid/pngtree-aesthetic-paper-notes-png-image_6098989.png"
                  alt=""
                  className="absolute left-0 top-1/2 -translate-y-1/2 w-32 h-32 opacity-10 pointer-events-none object-contain mix-blend-multiply grayscale -scale-x-100 rotate-12 group-hover:opacity-20 transition-opacity duration-500"
                  referrerPolicy="no-referrer"
                  loading="lazy"
                />
                <img 
                  src="https://png.pngtree.com/png-clipart/20220804/ourmid/pngtree-aesthetic-paper-notes-png-image_6098989.png"
                  alt=""
                  className="absolute right-0 top-1/2 -translate-y-1/2 w-32 h-32 opacity-10 pointer-events-none object-contain mix-blend-multiply grayscale -rotate-12 group-hover:opacity-20 transition-opacity duration-500"
                  referrerPolicy="no-referrer"
                  loading="lazy"
                />
